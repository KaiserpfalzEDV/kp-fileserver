...
import de.kaiserpfalzedv.fileserver.model.jpa.FileDescription;
...
public class DeliverResource {
    ...
    private Response returnFile(
        ...
        log.info("Loaded data. id='{}', type='{}', loaded={}", data.getMetadata().getUid(), type, file.isPresent());

        file.orElseThrow(NotFoundException::new);

        log.info("Delivering file. id={}, name='{}', mediaType='{}'",
                 data.getMetadata().getUid(), file.get().getName(), file.get().getMediaType());
        ...
        return Response
                ...
                .header("X-File-Metadata-Uid", data.getMetadata().getUid())
